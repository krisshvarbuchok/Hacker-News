...
const BodyOpenNew = () => {
  ...
  try {
    if (Object.keys(open).length === 0)
      throw new Error("The new is out of date");
  ...
  return (
    <div className={styles.body}>
      <div className={styles.title}>{open.title}</div>
      <div>
      ...
      <div className={styles.info}>
        ...
        <div>
          Published: {date.getHours().toString().padStart(2, "0")}:
        ...
        <div className={styles.comments}>
          ...
          {open.descendants !== 0 ? <p> {open.kids.length}</p> : <p>0</p>}
